...
public class MarkingSchemeReaderService {
    ...
    public XMLRubricRules readFromXML(DiagramType diagramType){
        ...
        try {
            File file = new File("E:\\FYP\\implementation\\parser2\\DiagramParser\\src\\main\\resources\\com\\Rubric\\"+fileName);
    ...
    public RubricRules convertXMLRubricRules(XMLRubricRules xmlRubricRules, DiagramType type) {
